...
files=['nexus/public/hub.php','nexus/public/hub-logic.js','nexus/public/core.php','nexus/public/data.php','nexus/public/site.css','nexus/public/site.js','nexus/assets/imc-logo.png','nexus/.htaccess','nexus/index.html']
for name in files:
    p=Path(name)
    ftp.cwd('/')
