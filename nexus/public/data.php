...
try {
    ...
    if (!isset($resources[$resource])&&!in_array($resource,['catalog','competition','players','stats','manager_profile','team_profile','competition_reports'],true)) respond(['ok'=>false,'error'=>'invalid_resource'],422);
