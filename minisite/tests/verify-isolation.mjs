...
// Phase 2 changes only these four entry points; the historical baseline stays immutable.
const integrated=new Set(['minisite/GW001/results.html','minisite/GW001/schedule.html','minisite/GW007/results.html','minisite/GW007/schedule.html']);
