...
(function(){
  ...
  const NEXUS_ROUTE_BASE = "/nexus-test";
  const NEXUS_BUILD = "53";
  const NEXUS_BUILD_LABEL = "BUILD " + NEXUS_BUILD;
  if(window.location.pathname !== "/nexus-test/" && window.location.pathname !== "/nexus-test/index.html"){
    window.history.replaceState(null,"","/nexus-test/index.html");
  }
  ...
  function syncRouteFromState(){
    ...
    // Tutta Nexus vive sempre su /nexus-test/index.html.
    return;
  }
